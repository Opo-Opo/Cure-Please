        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (var i = 0; i < TabCount; i++)
            {
                ...
                if (ImageList != null && ImageList.Images.Count >= i + 1)
                {
                    ...
                    var rectImage =
                        new Rectangle(new Point(bounds.X + space, bounds.Y + bounds.Height / 2 - imageWidth / 2),
                            new Size(imageWidth, imageWidth));
                ...
                var rectText = new Rectangle(bounds.X + imageWidth + space, bounds.Top, bounds.Width - imageWidth,
                    bounds.Height);
